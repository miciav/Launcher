		...
		<div id="featured-wrapper">
			...
			<div class="extra2 container">
					...
					<form action="registration" method="post">
						<table>
							<tr>
								...
								<td><font color="red">
									<span>${usernameMessage}</span></font></td>
							</tr>
							<tr>
								<td>Password:</td>
								...
								<td><font color="red">
									<span>${passwordMessage}</span></font></td>
							</tr>
							<tr>
								<td>Email:</td>
								...
								<td><font color="red">
									<span>${emailMessage}</span></font></td>
							</tr>
							<tr>
				...
				<p>
					...
					The photos in this template are from <a href="http://fotogrph.com/">
						Fotogrph</a>. This free template is released under a <a
						href="http://creativecommons.org/licenses/by/3.0/">Creative
						Commons Attributions 3.0</a> license, so you are pretty much free to
					do whatever you want with it (even use it commercially) provided
					you keep the links in the footer intact. Aside from that, have fun
					with it :)
				</p>
